...
export const fetchCentrality = (nodeId) =>
  api.get(`/nodes/${nodeId}/centrality`);
export const fetchRiskQueue = () => api.get("/risk-queue");
export const confirmRisk = (edgeId) =>
  api.post(`/risk-queue/${edgeId}/confirm`);
export const dismissRisk = (edgeId) =>
  api.post(`/risk-queue/${edgeId}/dismiss`);
